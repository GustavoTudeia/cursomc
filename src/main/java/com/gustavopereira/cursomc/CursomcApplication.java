	...
	public void run(String... args) throws Exception {
		...
		produtoRepository.saveAll(Arrays.asList(prod1, prod2, prod3));
		  ...
		  cidadeRepository.saveAll(Arrays.asList(cd1, cd2, cd3));
			  ...
			  Cliente cli1 = new Cliente(null, "Marina Silva", "maria@gmail.com",
			  "04937959603", TipoCliente.PESSOAFISICA);
			  cli1.getTelefones().addAll(Arrays.asList("3332256560", "33999797225"));
			  
			  Endereco e1 = new Endereco(null, "Rua Flores", "300", "Ap301", "Esplanada",
			  "39830000", cli1, cd1); Endereco e2 = new Endereco(null, "Avenida Matos",
			  "30", "sala 05", "Centro", "32420000", cli1, cd2);
			  
			  cli1.getEnderecos().addAll(Arrays.asList(e1,e2));
			  
			  clienteRepository.save(cli1); enderecoRepository.saveAll(Arrays.asList(e1,
			  e2));
			  ...
			  ItemPedido it1 = new ItemPedido(prod1, ped1, 0.00, 1, 2000.00); ItemPedido
			  it2 = new ItemPedido(prod3, ped1, 0.00, 2, 80.00); ItemPedido it3 = new
			  ItemPedido(prod2, ped2, 100.00, 1, 800.00);
			  
			  prod1.getItems().add(it1); prod2.getItems().add(it3);
			  prod3.getItems().add(it2);
			  
			  ped1.getItems().addAll(Arrays.asList(it1, it2)); ped2.getItems().add(it3);
