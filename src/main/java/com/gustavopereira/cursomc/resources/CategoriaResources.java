...
public class CategoriaResources {
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody CategoriaDTO objDTO){
		objDTO = new CategoriaDTO(service.insert(service.fromDTO(objDTO)));
	...
	public ResponseEntity<Page<CategoriaDTO>> findPage(@RequestParam(name = "page", defaultValue = "0") int page,
		...
		Page<Categoria> categorias = service.findPage(page, size, direction, properties);	
